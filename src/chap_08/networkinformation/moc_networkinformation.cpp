...
const QMetaObjectExtraData NetworkInformation::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject NetworkInformation::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_NetworkInformation,
      qt_meta_data_NetworkInformation, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &NetworkInformation::getStaticMetaObject() { return staticMetaObject; }
